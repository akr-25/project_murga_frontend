      ...
      <Offcanvas show={show} onHide={handleClose} style={{backgroundColor:"#4E73DF"}}>
        ...
        <Offcanvas.Body>
          ...
          <ListGroup variant="flush" >
            ...
            <ListGroup.Item style={{backgroundColor:"#4E73DF"}}><NavLink style={{'color':'white', fontSize: "18px"}} to='view_logs'  onClick={handleClose} className={isActive =>"nav-link" + (!isActive ? " unselected" : "")}>View Logs</NavLink></ListGroup.Item>
